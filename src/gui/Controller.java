...
public class Controller implements Initializable{
	...
	public Button GetStarted, SetKey, GenerateKey, AddFolder, Finish, AddFolderMain, RemoveFolder, ChangeKey, GenerateKeyChange, SetKeyChange, Back;
	public TextField Key, KeyChange;
	public Label KeyStatus, KeyStatusChange;
	...
	public void sceneChange(ActionEvent event) throws IOException{
		...
		}else if (event.getSource() == ChangeKey){
	...
	public void selectFolder(ActionEvent event) throws IOException{
		...
		if(event.getSource() == AddFolder){
			stage = (Stage) AddFolder.getScene().getWindow();
		}else{
			stage = (Stage) AddFolderMain.getScene().getWindow();
		}
