...
public class SimpleDirectoryWatchService implements DirectoryWatchService, Runnable {
    ...
    public void register(OnFileChangeListener listener, String dirPath, String... globPatterns)
        ...
        Logger.getLogger(SimpleDirectoryWatchService.class.getName()).log(Level.INFO, "Watching files matching " + Arrays.toString(globPatterns)+ " under " + dirPath + " for changes.");
    }
    ...
    public void run() {
        ...
        while (mIsRunning.get()) {
            ...
            try {
            	...
            	Logger.getLogger(SimpleDirectoryWatchService.class.getName()).log(Level.INFO, DirectoryWatchService.class.getSimpleName() + " service interrupted.");
                break;
            }
